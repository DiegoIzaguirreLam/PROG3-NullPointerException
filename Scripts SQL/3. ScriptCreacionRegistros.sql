...
CALL INSERTAR_PROVEEDOR(@id_proveedor, 'Ubisoof');
...
CALL INSERTAR_SOFTWARE(@id_software, 3, 'Wallpaper Engine', '2016-10-10', 20.00, 'Aplicacion para fondos de pantalla en alta calidad y animados', 20.00, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShoRHLNX2m9GQ-ziMfqlaSkfZH8m5YnhovOAWASmw8Dg&s', 'https://cdn.akamai.steamstatic.com/steam/apps/431960/header.jpg?t=1665921297', 1, 'Core i5 7th Generation', 'GPL');
...
CALL INSERTAR_JUEGO(@id_juego, 5, 'Fallout 4', '2015-11-10', 40.00, 'Juego de rol de acción ambientado en un mundo post-apocalíptico, desarrollado por Bethesda Game Studios', 8.00, 'https://imgur.com/Wlj77jZ', 'https://cdn.cloudflare.steamstatic.com/steam/apps/377160/header.jpg?t=1629138088', 1, 'Intel Core i5-2300 2.8 GHz', 'Intel Core i7-4790 3.6 GHz', 1);
