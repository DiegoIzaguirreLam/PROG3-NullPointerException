...
public class Principal {
    public static void main(String[] args) throws Exception {
        ...
        BandaSonoraDAO daoBS = new BandaSonoraMySQL();
        ArrayList<BandaSonora> bss = daoBS.listarBandaSonoras();
        for(BandaSonora bs : bss){
            System.out.println(sdf2.format(bs.getDuracion()));
        }
...
//        BandaSonora bandaSonora = new BandaSonora("Christopher Larkin", "Christopher Larkin", sdf2.parse("01:04:20"), "Hollow Knight - Official Soundtrack", sdf.parse("20-04-2024"), 0, 
